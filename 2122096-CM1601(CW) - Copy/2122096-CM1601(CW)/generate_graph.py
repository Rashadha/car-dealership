...
def create_a_list_with_number_of_sold_cars(number_of_sold_cars):
...
def find_total_income_by_selling_car(sheet_3,sheet_4):
...
def find_total_income_by_maintenance(sheet_5):
...
def create_total_income_list(total_income):
